...
namespace VaporStore.DataProcessor
{
	...
	public static class Deserializer
	{
		...
		public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
		{
			...
			var purcheses = new List<Purchase>();

			foreach (var purchaseDto in purchesesDto)
			{
				...
				var card = context.Cards.FirstOrDefault(x => x.Number == purchaseDto.Card); //TODO purchaseDto.Key
				...
				purcheses.Add(purches);
				sb.AppendLine($"Imported {purches.Game.Name} for {purches.Card.User.Username}");
			}

			context.Purchases.AddRange(purcheses);
			context.SaveChanges();
